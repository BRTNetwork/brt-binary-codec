...
const { encodeAccountID } = require("@brtnetwork/brt-address-codec");
...
function transactionParsingTests() {
  const transaction = {
    json: {
      Account: "bnU6FHLARsKdGYWa395Bk8gvQJMnb53pof",
      Fee: "10",
      Flags: 0,
      Sequence: 103929,
      SigningPubKey:
      ...
      TakerGets: {
        currency: "ILS",
        issuer: "bD4QDzww3Zw7rAssYbMqWUSvdeC7648ak3",
        value: "1694.768",
      },
...
function pathSetBinaryTests() {
  const bytes = __(
    `1200002200000000240000002E2E00004BF161D4C71AFD498D
    000000000000000000000000000055534400000000000A20B3C
    85F482532A9578DBB3950B85CA06594D168400000000000000A
    69D446F8038585E940000000000000000000000000425443000
    000000078CA21A6014541AB7B26C3929B9E0CD8C284D61C7321
    03A4665B1F0B7AE2BCA12E2DB80A192125BBEA660F80E9CEE13
    7BA444C1B0769EC7447304502205A964536805E35785C659D1F
    9670D057749AE39668175D6AA75D25B218FE682E0221009252C
    0E5DDD5F2712A48F211669DE17B54113918E0D2C266F818095E
    9339D7D3811478CA21A6014541AB7B26C3929B9E0CD8C284D61
    C83140A20B3C85F482532A9578DBB3950B85CA06594D1011231
    585E1F3BD02A15D6185F8BB9B57CC60DEDDB37C100000000000
    00000000000004254430000000000585E1F3BD02A15D6185F8B
    B9B57CC60DEDDB37C131E4FE687C90257D3D2D694C8531CDEEC
    BE84F33670000000000000000000000004254430000000000E4
    FE687C90257D3D2D694C8531CDEECBE84F3367310A20B3C85F4
    82532A9578DBB3950B85CA06594D10000000000000000000000
    0042544300000000000A20B3C85F482532A9578DBB3950B85CA
    06594D13000000000000000000000000055534400000000000A
    20B3C85F482532A9578DBB3950B85CA06594D1FF31585E1F3BD
    02A15D6185F8BB9B57CC60DEDDB37C100000000000000000000
    00004254430000000000585E1F3BD02A15D6185F8BB9B57CC60
    DEDDB37C131E4FE687C90257D3D2D694C8531CDEECBE84F3367
    0000000000000000000000004254430000000000E4FE687C902
    57D3D2D694C8531CDEECBE84F33673115036E2D3F5437A83E5A
    C3CAEE34FF2C21DEB6180000000000000000000000004254430
    00000000015036E2D3F5437A83E5AC3CAEE34FF2C21DEB61830
    00000000000000000000000055534400000000000A20B3C85F4
    82532A9578DBB3950B85CA06594D1FF31585E1F3BD02A15D618
    5F8BB9B57CC60DEDDB37C100000000000000000000000042544
    30000000000585E1F3BD02A15D6185F8BB9B57CC60DEDDB37C1
    3157180C769B66D942EE69E6DCC940CA48D82337AD000000000
    000000000000000425443000000000057180C769B66D942EE69
    E6DCC940CA48D82337AD1000000000000000000000000000000
    000000000003000000000000000000000000055534400000000
    000A20B3C85F482532A9578DBB3950B85CA06594D100`
  );

  const expectedJSON = [
    [
      {
        account: "b3sNU2MxwEQawepWfNMoqbUVPwAX1rxemJ",
        currency: "BTC",
        issuer: "b3sNU2MxwEQawepWfNMoqbUVPwAX1rxemJ",
      },
      {
        account: "bLi8FJ1asizC5cAC2oknQkf21aEwWZ6x78",
        currency: "BTC",
        issuer: "bLi8FJ1asizC5cAC2oknQkf21aEwWZ6x78",
      },
      {
        account: "bvXAaV56CsgT87gaVfZYz4fA9MNu2t63w",
        currency: "BTC",
    ...
    [
      ...
      {
        account: "brvaHMkQgPPAd8CrWNJhuyEwxmkXeRhXYq",
        currency: "BTC",
        issuer: "brvaHMkQgPPAd8CrWNJhuyEwxmkXeRhXYq",
      },
      {
        currency: "USD",
        issuer: "bvXAaV56CsgT87gaVfZYz4fA9MNu2t63w",
    ...
    [
      ...
      {
        account: "bfAV2crZ5PKWKy9Hyrc8D97Rvbmixtfush",
        currency: "BTC",
        issuer: "bfAV2crZ5PKWKy9Hyrc8D97Rvbmixtfush",
      },
      { currency: "BRT" },
      {
        currency: "USD",
